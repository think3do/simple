...
function modal(e) {
	...
	jAlert = function(message, title, callbackMethod, jsonData) {
	...
	jWarningAlert = function(message, title, callbackMethod, jsonData) {
	...
	jErrorAlert = function(message, title, callbackMethod, jsonData) {
	...
	jConfirm = function(message, title, callbackTrue, callbackFalse) {
	...
	// typeGubun success, warning, info, error
	jAlertBox = function(gubun, message){
		
		var typeGubun = gubun.toUpperCase();
		var typeTmp = "";
