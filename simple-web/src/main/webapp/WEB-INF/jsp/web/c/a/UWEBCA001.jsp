      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">고객정보등록</h2>
            <!-- <p></p> -->
            
			<form:form name="cstmForm" id="cstmForm" method="post" action="/cstm/insertCstm.do" modelAttribute="cstmSVO" >
			  <input type="hidden" name="screenId" value="UWEBAA001" />
			  
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="cstmNm">고객명</label>
                    <input type="text" class="form-control" id="cstmNm" name="cstmNm" placeholder="홍길동" required maxlength="50">            
                </div>
                
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="cstmDscmNo">주민등록번호</label>
                    <input type="text" class="form-control" id="cstmDscmNo" name="cstmDscmNo" placeholder="*************" required minLength="6" maxlength="13">                  
                </div> 
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                   
                    ...
                    <div class="margin-right-15 templatemo-inline-block">
                      <input type="radio" name="sexClCd" id="sexClCd01" value="1" checked>
                      <label for="sexClCd01" class="font-weight-400"><span></span>남</label>
                    </div>
                    <div class="margin-right-15 templatemo-inline-block">
                      <input type="radio" name="sexClCd" id="sexClCd02" value="2" >
                      <label for="sexClCd02" class="font-weight-400"><span></span>여</label>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="cstmAdr">주소</label>
                    <input type="text" class="form-control" id="cstmAdr" name="cstmAdr" placeholder="세종특별시 나성동" required maxlength="50" >                  
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="text" class="form-control" id="telNo" name="telNo" placeholder="044-123-1234" maxlength="13" >                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="schNm">학교명(유치원등)</label>
                    <input type="text" class="form-control" id="schNm" name="schNm" maxlength="50" >                  
                </div>
              </div>
