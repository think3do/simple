      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          ...
          <div class="templatemo-content-widget white-bg board">
            <h2 class="margin-bottom-10">결제정보</h2>
           <!--  <p>결제정보를 조회합니다.</p> -->
            ...
            <div class="table-responsive">
	             <table class="table table-striped table-bordered templatemo-user-table">
	               ...
	               <tbody>
                    ...
                    <c:forEach var="payDVO" items="${resultList}" varStatus="status">
                    <!-- loop 시작 -->   
		                 <tr>
		                   <td><c:out value="${paginationInfo.totalRecordCount+1 - ((searchVO.pageIndex-1) * searchVO.pageSize + status.count)}"/></td>
		                   <td><c:out value='${payDVO.cstmNm}'/></td>
		                   <td><c:out value='${payDVO.payDt}'/></td>
		                   <td><c:out value='${payDVO.payYyyyMm}'/></td>
		                   <td><c:out value='${payDVO.payAmt}'/></td>
		                   <td><c:out value='${payDVO.emlAdr}'/></td>
		                   <td><c:out value='${payDVO.cnclYn}'/></td>
		                   <td><a href="javascript:void(0)" onclick="fn_detail('<c:out value='${payDVO.cstmUserNo}'/>')" class="templatemo-edit-btn">Edit</a></td>
		                 </tr> 
                    </c:forEach>               
	               </tbody>
	             </table>    
